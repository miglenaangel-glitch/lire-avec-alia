...
6. **Никога не се прескача ниво** — прогресията е строга
7. **Системата говори на глас подканата** — Alia не може да чете

### 4.2. Прагове за награда (Karumi + фрази)

| Ниво | Минимум упражнения | Точност |
|------|-------------------|---------|
| Гласни (`voyelles`) | собствена логика (6 × 3 = 18) | — |
| Срички (`consonnes_1`) | 25 | ≥ 70% |
| Бързо четене (`lecture_rapide`) | 20 | ≥ 70% |
| Думи (`mots_simples`) | 20 | ≥ 70% |
| Фрази (`phrases`) | 15 | ≥ 70% |

Наградата се показва само веднъж на сесия. Логиката живее в `routes/api.py` → `thresholds` речник.
